                            ...
                            <div className="bg-white rounded-xl shadow-sm border">
                                <div className="p-6 border-b flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Latest academic data exports</p>
                                    </div>
                                    <button
                                        onClick={() => router.push('/teacher/reports')}
                                            ...
                                            >
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <div className="text-xs text-gray-500">
                                                            {report.report_type.replace('_', ' ')} • {format(new Date(report.created_at), 'MMM dd, hh:mm a')}
                                                        </div>
                                                    </div>
                                                </div>
                                                <a
                                                    ...
                                                    className="px-3 py-1 bg-blue-50 text-blue-600 text-xs rounded hover:bg-blue-100 font-medium"
                                                >
                                                    Download
                                                </a>
                                            </div>
