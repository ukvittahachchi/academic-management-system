...
interface ClientDownloadsProps {
    initialDownloads: DownloadableContent[] | null;
}

export default function ClientDownloads({ initialDownloads }: ClientDownloadsProps) {
    const [downloads, setDownloads] = useState<DownloadableContent[]>(initialDownloads || []);
    const [filteredDownloads, setFilteredDownloads] = useState<DownloadableContent[]>(initialDownloads || []);
    const [loading, setLoading] = useState<boolean>(false);
    const [error, setError] = useState<string | null>(initialDownloads === null ? 'Failed to load downloads' : null);
    ...
    // No need to load downloads on mount
