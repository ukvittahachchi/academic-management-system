...
import { LuSearch, LuBookOpen, LuChevronRight, LuGraduationCap, LuClock } from "react-icons/lu";

export default function ClientStudentModules() {
    ...
    if (error) return <div className="p-8 bg-gray-50/50 min-h-screen"><ErrorMessage error={error} onRetry={loadModules} /></div>;
